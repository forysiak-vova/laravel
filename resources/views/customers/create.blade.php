         ...
         <div class="col-lg-8 col-xl-7">
            ...
            <form action="{{ route('customers.store') }}" method="POST" name="submit">
               ...
               <div class="form-floating mb-3">
                  <input class="form-control" id="name" name="name" type="text" placeholder="Nazwa" />
                  <label for="name">Nazwa klienta</label>
                  <div class="invalid-feedback">A name is required.</div>
               </div>
               <!-- Email address input-->
               <div class="form-floating mb-3">
                  <input class="form-control" id="adress" name="adress" type="text" placeholder="Adress klienta" />
